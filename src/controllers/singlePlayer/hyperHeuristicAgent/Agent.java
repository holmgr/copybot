...
public class Agent extends AbstractPlayer {
    ...
    public Agent(StateObservation so, ElapsedCpuTimer elapsedTimer) throws IOException
    {
        ...
        builder.append("{");
        builder.append("numTypesResources=").append(features.get("numTypesResources")).append(", ");
        builder.append("numNPCTypes=").append(features.get("numNPCTypes")).append(", ");
        builder.append("blockSize=").append(features.get("blockSize")).append(", ");
        builder.append("numPortals=").append(features.get("numPortals")).append(", ");
        builder.append("isUseAvailable=").append(features.get("isUseAvailable")).append(", ");
        builder.append("canMoveVertically=").append(features.get("canMoveVertically")).append("}\n");
