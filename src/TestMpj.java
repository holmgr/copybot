...
public class TestMpj {
    ...
    public static void main(String[] args) {
        ...
        List<String> controllers = Arrays.asList(
                ...
                "controllers.singlePlayer.hyperHeuristicAgent.Agent"
        );
        ...
        int[] wins = testController(controllers.get(me), validationSet, VALIDATION_SET_SIZE, NUMBER_OF_LEVELS, 1);
    ...
    private static int[] testController(String controller, List<String> gameSet, int trainingSetSize, int numberOfLevels, int numberOfTries) {
